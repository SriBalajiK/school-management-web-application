...
public class MarksEntryElevenA {
    ...
    public static void ElevenArts(String roll_no, String subjects, String terms, String years, String theory_mark, String practical_mark, String commenting) throws InterruptedException {
    ...
    public static void markentryselection(){
       ...
       classsection.click();
       WebElement department=driver.findElement(By.xpath("//select//option[@value='Arts']"));
       department.click();
