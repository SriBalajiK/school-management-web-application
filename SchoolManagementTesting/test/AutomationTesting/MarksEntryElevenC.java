...
public class MarksEntryElevenC {
    ...
    public static void ElevenCommerce(String roll_no, String subjects, String terms, String years, String theory_mark, String practical_mark, String commenting) throws InterruptedException {
    ...
    @BeforeTest
    public static void markentryselection(){
       ...
       classsection.click();
       WebElement department=driver.findElement(By.xpath("//select//option[@value='Commerce']"));
       department.click();
